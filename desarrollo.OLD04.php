...
<head>
<meta charset="UTF-8">
<title>AACTUN-HA - Desarrollo ROES & CO</title>
...
<div class="page-wrapper">
    ...
    <div class="banner-section">
		<div class="main-slider-carousel owl-carousel owl-theme">
			...
			<div class="slide" data-bg-image="images/main-slider/AACTUN-HA.jpg">
	...
	<div class="about-section">
		<div class="auto-container">
				...
				<div class="row align-items-center clearfix">
					...
					<div class="content-column col-lg-6 col-md-12 col-sm-12 mb-0">
						<div class="about-column">
							<div class="sec-title"> 
								<h2><span>A'ACTUN-HA </span></h2>
								<h2>INVIERTE EN TU PATRIMONIO FAMILIAR</h2> 
							</div>
							<div class="text">
								<h5>Es un fraccionamiento campestre urbanizado con amenidades encantadoras y con una locación estratégica por estar cerca de  playas que tendrán una excelente proyección turística como lo son el pueblo mágico de “Sisal”  la reserva ecológica  “Celestún” </h5>
								<br>
					...
					<div class="image-column col-lg-6">
						<div class="about-image">
							<div class="about-inner-image">
								<img src="images/desarrollo/aactun_1.jpg" alt="about">
							</div>
						</div>
					</div>
			...
			<iframe width="100%" height="550" src="https://www.youtube-nocookie.com/embed/Zz1Q_eU368E" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			...
			<div class="inner-container">
				<div class="row align-items-center clearfix">
					...
					<div class="image-column col-lg-12">
						<div class="about-image">
							<div class="about-inner-image">
								<img src="images/desarrollo/actun_ubicacion.jpg" alt="about">
							</div>
						</div>
					</div> 
...
* Caseta, Acceso Y Vigilancia las 24 horas todo el año.</h5> 
					...
					<div class="image-column col-lg-6">
						<div class="about-image">
							<div class="about-inner-image">
								<img src="images/desarrollo/actun_lotes2.jpg" alt="about">
							</div>
						</div>
					</div>
				...
				<div class="row align-items-center clearfix">
					...
					<div class="col-md-12" id="contacto_desa"> 
						...
						<h4>¡No dudes en contactarnos!</h4>
										...
										<input type="hidden" id="nombre_desarrollo" value="AACTUN-HA">									 
										<div class="row" >
