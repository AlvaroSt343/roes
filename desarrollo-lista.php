...
<head>
<meta charset="UTF-8">
<title>Desarrollos y proyectos - ROES & CO</title>
...
<div class="page-wrapper">
    ...
    <header class="main-header">
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
                <div class="nav-logo"><a href="./"><img src="images/logo.png" alt="ROES & CO" title=""></a></div>
    ...
    <div class="banner-section">
		<div class="main-slider-carousel owl-carousel owl-theme">
			...
			<div class="slide" data-bg-image="images/main-slider/desarrollos.jpg">
					...
					<div class="row clearfix">
						...
						<div class="content-column col-lg-8 col-md-12 col-sm-12">
							<div class="inner-column">
								...
								<h1>DESARROLLOS <span> TIME 2 INVEST</span></h1>-->
								<h1 style="color: #FFFFFF;">DESARROLLOS</h1>
			...
			<div class="sec-title">
				<div class="clearfix">
					...
					<div class="pull-right">
						<a href="#" class="cases">VER TODO <span class="arrow ti-angle-right"></span></a>
					</div>
				</div>
			</div>
			-->
		...
		<div class="outer-container">
			<div class="row clearfix">
				...
				while ($rows=mysqli_fetch_array($sql_consulta)){
					...
					echo '<div class="column col-lg-10">
