...
//                Logger::info("after_insert");
    ...
    public static function load_js()
    {
        ...
        if (Xcrud_config::$load_googlemap)
            $out .= '<script src="//maps.google.com/maps/api/js?key=AIzaSyCU8Q3wt1bt4sdCsMXE8jNE7fSuWHDEzng&sensor=false&language=' . $language . '"></script>';
