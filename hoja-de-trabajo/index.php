                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-6 text wow fadeInUp">
                                <div class="top-buttons fadeInDown"> 
                                    ...
                                    <input type="text" id="ocupacion" value="<?php echo $numcontiza['ocupacion'];?>" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6 text wow fadeInUp">
                                <div class="top-buttons fadeInDown"> 
                                    <label>ESTADO CIVIL:</label>
                                    <input type="text" id="ecivil" value="<?php echo $numcontiza['ecivil'];?>"  class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6 text wow fadeInUp">
                                <div class="top-buttons fadeInDown"> 
