...
*                                                                              *
*******************************************************************************/
function FPDF($orientation='P', $unit='mm', $format='A4', $companyExtend = array()){
	//Some checks
	$this->_dochecks();
...
function AddPage($orientation='', $format='')
{
	...
	//Page header
	$this->InHeader=true;
	$this->Header($this->companyExtend);
	$this->InHeader=false;
	//Restore line width
...
function _putinfo()
{
	$this->_out('/Producer '.$this->_textstring('Custom '.FPDF_VERSION));
	if(!empty($this->title))
