...
function save_hojatrabajo(id_cot){ 
	...
	var origen_cli =document.getElementById("origen_cli").value;
	...
	var m2_lote =document.getElementById("m2_lote").value;
	var precio_m2 =document.getElementById("precio_m2").value;
	var valor_m2 =document.getElementById("valor_m2").value;
	var promocion=document.getElementById("promocion").value; 
	var enganche =document.getElementById("enganche").value;
	var fecha_pagoengan =document.getElementById("fecha_pagoengan").value;
	var financia =document.getElementById("financia").value;
	...
	if(cerrador==""){
		alert("Ingrese el nombre del cerrador");
		document.getElementById("cerrador").focus();
		return false;
	}
	 
	if(asesor==""){
		alert("Ingrese nombre del asesor");
		document.getElementById("asesor").focus();
		return false;
	} 
	if(proyecto==""){
		alert("Ingrese nombre del desarrollo o proyecto");
		document.getElementById("proyecto").focus();
		return false;
	}
	if(m2_lote==""){
		alert("Ingrese metros cuadrados del Lote");
		document.getElementById("m2_lote").focus();
		return false;
	}

	if(promocion==""){
		alert("Ingrese el tipo de promocion");
		document.getElementById("promocion").focus();
		return false;
	}
	 
	var abrir=new creaXMLHttpRequest();
	abrir.open("POST","php/save_hojatrabajo.php");
	...
	abrir.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
	abrir.send("fecha="+fecha+"&nombre="+nombre+"&tel="+tel+"&email="+email+"&metodopago="+metodopago
		+"&cerrador="+cerrador+"&asesor="+asesor+"&tipo_asesor="+tipo_asesor+"&origen_cli="+origen_cli+"&plaza="+plaza
		+"&proyecto="+proyecto+"&manzana="+manzana+"&num_lote="+num_lote+"&etapa="+etapa+"&m2_lote="+m2_lote+"&precio_m2="+precio_m2
		+"&valor_m2="+valor_m2+"&promocion="+promocion+"&enganche="+enganche+"&fecha_pagoengan="+fecha_pagoengan
		+"&financia="+financia+"&comentario="+comentario+"&id_cot="+id_cot+"&ocupacion="+ocupacion+"&ecivil="+ecivil);
