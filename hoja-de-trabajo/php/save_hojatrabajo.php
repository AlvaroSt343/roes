...
$sql_insert= mysqli_query($con,"INSERT INTO `web_coti_hojat`( `id_cot`, `fecha`, `nombre`, `tel`, `email`, `metodopago`, `cerrador`, `asesor`, `tipo_asesor`, `origen_cli`, `plaza`, `proyecto`, `manzana`, `num_lote`, `etapa`, `m2_lote`, `precio_m2`, `valor_m2`, `promocion`, `enganche`, `fecha_pagoengan`, `financia`, `comentario`, `ocupacion`, `ecivil`)

    VALUES ('$id_cot', '$fecha','$nombre', '$tel','$email','$metodopago','$cerrador','$asesor','$tipo_asesor','$origen_cli','$plaza','$proyecto','$manzana','$num_lote','$etapa','$m2_lote','$precio_m2','$valor_m2','$promocion', '$enganche', '$fecha_pagoengan', '$financia','$comentario', '$ocupacion','$ecivil' ) ");
