...
class Xcrud_config
{
    // default connection
   /* 
    public static $dbname = 'db_inversionista'; // Your database name
    public static $dbuser = 'root'; // Your database username
    public static $dbpass = 'admin01*'; // Your database password
    public static $dbhost = 'localhost'; // Your database host, 'localhost' is default.
  */
    public static $dbname = 'bd_time2invest'; 
    public static $dbuser = 'CRMtime2invest';  
    public static $dbpass = 'time2invest2022*';  
