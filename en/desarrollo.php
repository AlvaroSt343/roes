...
$n_descripcion_en= $seo_opti['n_descripcion_en'];
$n_imagen_750x700= $seo_opti['n_imagen_750x700'];
$video_youtube= $seo_opti['video_youtube'];
$ubicacion_en= $seo_opti['ubicacion_en'];
$u_descripcion_en= $seo_opti['u_descripcion_en'];
$u_imagen1200x= $seo_opti['u_imagen1200x'];
$lotes_en= $seo_opti['lotes_en'];
$link_lotes= $seo_opti['link_lotes_en'];
$amenidades_en= $seo_opti['amenidades_en'];
$a_imagen700x700= $seo_opti['a_imagen700x700'];
$costos_en= $seo_opti['costos_en'];
$c_descripcion_en= $seo_opti['c_descripcion_en'];
$fondo_amenid_1900= $seo_opti['fondo_amenid_1900'];

$mas_desc1_en= $seo_opti['mas_desc1_en'];
...
<head>
<meta charset="UTF-8">
<title><?php echo $nombre;?> - ROES & CO</title>
			...
			<div class="inner-container">
				<div class="row align-items-center clearfix">
					...
					<div class="content-column col-lg-12 col-md-12 col-sm-12 mb-0">
						<div class="about-column">
							<div class="sec-title"> 
								<h2><span>AVAILABLE LOTS</span> </h2>
							</div>
							<div class="text">
								<h5><?=$lotes_en;?></h5>
								<!--
			...
			<div class="inner-container">
				<div class="row align-items-center clearfix">
					...
					<div class="content-column col-lg-12 col-md-12 col-sm-12 mb-0">
						<div class="about-column">
							<div class="sec-title"> 
								<h2><span>Costs and Financing</span> </h2>
							</div>
							<div class="text">
								<!--
					...
					<div class="col-md-12" id="contacto_desa"> 
						<h3 style="color:#001E47 ;">Do you need more info?</h3>
						<h4>Feel free to contact us!</h4>
										...
										<div class="row" >
                                            ...
                                            <div class="form-group col-12 pb-2 col-md-2">
                                                <button onclick="contacto_desarrollo()" class="btn btn-primary" style="width: 100%;border-radius:1rem;">Send</button>
                                            </div>
                                        </div>
