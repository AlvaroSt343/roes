...
//include("class.smtp.php");
 ...
 $nombre=htmlentities($_POST['name_h'], ENT_QUOTES, "UTF-8"); 
 $email=$_POST['email_h']; 
 $phone=$_POST['phone_h'];  
 $coment=htmlentities($_POST['howMeet_h'], ENT_QUOTES, "UTF-8");  
 $lang=$_POST['lang'];
...
function GetUserIP() {
  ...
  <table width="600" border="0" align="center">
    <tr><th colspan="2" scope="col"><strong>DATOS CONTACTO INCIO EN ('.date("d-m-Y").')</strong></th></tr>
    ...
    <tr><td height="64"><strong>MENSAJE</strong>:</td> <td>'.$coment.'</td> </tr>
    <tr><td height="46" colspan="2" align="center">Enviado en sitio web  inversionesconplusvalia.com/en - Inicio.</td></tr>
    <tr><td height="10" bgcolor="#00CA5B" colspan="2"> </td></tr>
