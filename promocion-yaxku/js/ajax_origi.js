...
function registro(){ 
	...
	abrir.open("POST","php/send_registro.php");
		document.getElementById("registro").innerHTML="<img src='images/ajax-loader.gif' />";
		abrir.onreadystatechange= function(){
			if(abrir.readyState==4){
				document.getElementById("registro").innerHTML=abrir.responseText;
			}
		}
		abrir.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
		abrir.send("name="+name+"&email="+email+"&tel="+tel+"&mensaje="+mensaje);
}
