...
function view_consultar(){ 
	var dep_inicial=document.getElementById("dep_inicial").value;
	var aportar_anual=document.getElementById("aportar_anual").value; 
	var increm_anual =document.getElementById("increm_anual").value;
	var anio_inversion =document.getElementById("anio_inversion").value; 
	var rendim_anual =document.getElementById("rendim_anual").value;

	//var lang= "es";
	if(dep_inicial==""){
		alert("Ingrese el Deposito Inicial");
		document.getElementById("dep_inicial").focus();
		return false;
	}
	if(aportar_anual==""){
		alert("Ingrese Aportacion Anual");
		document.getElementById("aportar_anual").focus();
		return false;
	}
	if(increm_anual==""){
		alert("Ingrese Incremento Anual");
		document.getElementById("increm_anual").focus();
		return false;
	}
	if(rendim_anual==""){
		alert("Ingrese Rendimiento Anual");
		document.getElementById("rendim_anual").focus();
		return false;
	}
	var abrir=new creaXMLHttpRequest();
	abrir.open("POST","php/view_consultar.php");
		document.getElementById("dinamico").innerHTML="<img src='images/ajax-loader.gif' />";
		...
		abrir.send("dep_inicial="+dep_inicial+"&aportar_anual="+aportar_anual+"&increm_anual="+increm_anual
			+"&anio_inversion="+anio_inversion+"&rendim_anual="+rendim_anual);
}
