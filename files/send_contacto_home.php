...
function GetUserIP() {
  ...
  <table width="600" border="0" align="center">
    <tr><th colspan="2" scope="col"><strong>DATOS CONTACTO INCIO ('.date("d-m-Y").')</strong></th></tr>
    ...
    <tr><td height="46" colspan="2" align="center">Enviado en sitio web  inversionesconplusvalia.com - Inicio.</td></tr>
