...
$pdf->Image('images/inversion-banner.jpg',6,5,196,48,0, '', '', true);
...
$pdf->MultiCell(90,2,utf8_decode("FORMATO DE COTIZACIÓN"),0,'L');
		...
		$pdf->SetFillColor(255, 255, 255);
		$pdf->SetTextColor(0, 0,  0);
		$pdf->Cell(95, 6,utf8_decode("NÚMERO DE LOTE: ").$res['nlote'], 1, 0);
		$pdf->SetFillColor(255, 255, 255);
		$pdf->SetTextColor(0, 0,  0);
		...
		$pdf->SetFillColor(255, 255, 255);
		$pdf->SetTextColor(0, 0,  0);
		$pdf->Cell(95, 6,"METROS CUADRADOS DEL LOTE: ".$res['m2_lote'], 1, 0);
		$pdf->SetFillColor(255, 255, 255);
		$pdf->SetTextColor(0, 0,  0);
		$pdf->Cell(97, 6,"PRECIO DEL METRO CUADRADO: $ ".$precio_m2, 1, 0,'l',true);

		$pdf->Ln(6);
		$pdf->SetFont('Arial','B',6);
		$pdf->SetFillColor(255, 255, 255);
		$pdf->SetTextColor(0, 0,  0);
		$pdf->Cell(95, 6,"VALOR DEL LOTE: $ ".$val_lote, 1, 0);
		$pdf->SetFillColor(255, 255, 255);
		$pdf->SetTextColor(0, 0,  0);
		...
		$pdf->SetFillColor(255, 255, 255);
		$pdf->SetTextColor(0, 0,  0);
		$pdf->Cell(97, 6,utf8_decode("PRECIO METRO CUADRADO CON PROMOCIÓN: $ ").$precio_m2_promo, 1, 0,'l',true);
		...
		$pdf->SetFillColor(255, 255, 255);
		$pdf->SetTextColor(0, 0,  0);
		$pdf->Cell(97, 6,utf8_decode("VALOR DE LOTE CON PROMOCIÓN: $ ").$val_lote_promo, 1, 0,'l',true);
		...
		$pdf->SetFillColor(255, 255, 255);
		$pdf->SetTextColor(0, 0,  0);
		$pdf->Cell(97, 6,"MONTO DE ENGANCHE: $ ".$monto_enganche, 1, 0,'l',true);

		$pdf->Ln(6);
		$pdf->SetFont('Arial','B',6);
		$pdf->SetFillColor(255, 255, 255);
		$pdf->SetTextColor(0, 0,  0);
		$pdf->Cell(95, 6,"SALDO DEL LOTE: $ ".$saldo_lote, 1, 0);
		$pdf->SetFillColor(255, 255, 255);
		$pdf->SetTextColor(0, 0,  0);
		$pdf->Cell(97, 6,"    ", 1, 0,'l',true);
		...
		$pdf->SetFillColor(166, 166, 166);
		$pdf->SetTextColor(0, 0,  0);
		$pdf->Cell(97, 6,"MONTO MENSUAL $ ".$monto_mes,1, 0,'C',true);
		/*
		$pdf->Ln(6);
		$pdf->SetFont('Arial','B',7);
		$pdf->SetFillColor(255, 255, 255);
		...
		*/
		...
		$pdf->SetFillColor(255, 255, 255);
		$pdf->SetTextColor(0, 0,  0);
		$pdf->Cell(95, 7,"COSTO ADMINISTRATIVO: $ ".$costo_admin, 1,0,'L',true);
		$pdf->SetFillColor(255, 255, 255);
		$pdf->SetTextColor(0, 0,  0);
		$pdf->Cell(97, 7,"    ", 1,0,'L',true);
		...
		$pdf->SetFillColor(255, 255, 255);
		$pdf->SetTextColor(0, 0,  0);
		$pdf->Cell(95, 7,"ENGANCHE: $ ".$costo_enganche, 1,0,'L',true);
		$pdf->SetFillColor(255, 255, 255);
		$pdf->SetTextColor(0, 0,  0);
		$pdf->Cell(97, 7,"    ", 1,0,'L',true);
		...
		$pdf->SetFillColor(255, 255, 255);
		$pdf->SetTextColor(0, 0,  0);
		$pdf->Cell(95, 7,"TOTAL A PAGAR = $ ".$total_pago, 1,0,'L',true);
		$pdf->SetFillColor(255, 255, 255);
		$pdf->SetTextColor(0, 0,  0);
		$pdf->Cell(97, 7,"    ", 1,0,'L',true);
		...
		//$pdf->Image('images/payment.jpg',6,-30,56,8,0, '', '', true);
