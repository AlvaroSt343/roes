                ...
                <div class="row" >
                    ...
                    <div class="col-md-10 text wow fadeInUp">
                        <div class="col-md-6"> 
                            ...
                            <!-- <input type="text" id="porce_enganche"  class="form-control1">-->
                            ...
                            <input type="hidden" id="saldo_lote2" value="'.$l2_saldo.'" class="form-control1">
                        </div> 
                        <div class="col-md-6">
                            <label>MONTO DE ENGANCHE:</label>
                            <input type="text" id="monto_enganche" class="form-control1"> 
                            <input type="hidden" id="monto_enganche2" value="'.$l2_porcentaje.'" class="form-control1">
                        </div>
                    </div>
                    <div class="col-md-10 text wow fadeInUp" >
                        <center>&nbsp;</center>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 footer-menu fadeInLeft">
                        <ul>
                            ...
                            <!-- <li><a href="http://www.myvacations4life.com/terminos_en.php" target="_blank">Terms</a></li> -->
                        </ul>
                    </div>
                </div>
            </div>
