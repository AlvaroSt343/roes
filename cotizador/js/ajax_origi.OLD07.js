...
function ver_lote_promo(){ 
	...
	abrir.open("POST","php/ver_lote_promo.php");
		...
		abrir.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
		abrir.send("nlote="+nlote+"&m2_lote="+m2_lote+"&precio_m2_promo="+precio_m2_promo+"&val_lote="+val_lote+"&tipo_promo="+tipo_promo+"&valor_descuento="+valor_descuento+"&moneda_pm2="+moneda_pm2);
}
...
function ver_promo_preciom2(){ 
	...
	abrir.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
	abrir.send("nlote="+nlote+"&precio_m2_promo="+precio_m2_promo+"&val_lote="+val_lote+"&tipo_promo="+tipo_promo+"&valor_descuento="+valor_descuento);
