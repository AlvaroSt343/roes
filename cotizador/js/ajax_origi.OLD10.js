...
function agregar_lotes(){ 
	var agregar_lotes =document.getElementById("agregar_lotes").value;
	var lang= "es";
	/*
	if(name_h==""){
	...
	abrir.open("POST","php/agregar_lotes.php");
	document.getElementById("ver_mas_lotes").innerHTML="<img src='images/ajax-loader.gif' />";
	abrir.onreadystatechange= function(){
		if(abrir.readyState==4){
			document.getElementById("ver_mas_lotes").innerHTML=abrir.responseText;
		}
	}
	abrir.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
	abrir.send("agregar_lotes="+agregar_lotes+"&lang="+lang);
}

function ver_lote_mas(num){ 
	var num= num;
	var nlote =document.getElementById("nlote"+num).value;	
	var precio_m2 =document.getElementById("precio_m2").value;
	var desarrollo =document.getElementById("desarrollo").value;		  
	if (nlote=="") { nlote=0;}else{	nlote=nlote;}
	if (precio_m2=="") { precio_m2=0;}else{	precio_m2=precio_m2;}

	document.getElementById("val_lote_promo").value="";
	document.getElementById("precio_m2_promo").value="";
	document.getElementById("saldo_lote").value="";
	document.getElementById("saldo_lote2").value="";
	document.getElementById("monto_enganche").value="";
	document.getElementById("monto_enganche2").value="";	

	var abrir=new creaXMLHttpRequest();
	abrir.open("POST","php/add_lote_mas.php");
	document.getElementById("lote_div"+num).innerHTML="<img src='images/ajax-loader.gif' />";
	abrir.onreadystatechange= function(){
		if(abrir.readyState==4){
			document.getElementById("lote_div"+num).innerHTML=abrir.responseText;
		}
	}
	abrir.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
	/*abrir.send("name_h="+name_h+"&email_h="+email_h+"&phone_h="+phone_h+"&howMeet_h="+howMeet_h+"&lang="+lang);*/
	abrir.send("nlote="+nlote+"&precio_m2="+precio_m2+"&desarrollo="+desarrollo+"&num="+num);
}
...
function cargar_desarrollo(lote,newdesarrollo){ 
	
	var newdesarrollo= newdesarrollo;
	var lote= lote;
	 
	ver_lote();	
	/*	
	document.getElementById("costo_enganche").value= "";
	document.getElementById("costo_enganche2").value= "";
	document.getElementById("total_pago").value="";
	document.getElementById("total_pago2").value="";
	inversion_inicial();
	*/
}

function ver_campo_tpromo(){ 
	
	var tipo_promo= document.getElementById("tipo_promo").value;
	if(tipo_promo=="BONO"){
		document.getElementById("precio_m2_promo").value="0";
		document.getElementById("val_lote_promo").value="";
	...
	var abrir=new creaXMLHttpRequest();
	abrir.open("POST","php/ver_tipo_promo.php");
	document.getElementById("ver_tipo_promo").innerHTML="<img src='images/ajax-loader.gif' />";
	abrir.onreadystatechange= function(){
		if(abrir.readyState==4){
			document.getElementById("ver_tipo_promo").innerHTML=abrir.responseText;
		}
	}
	abrir.setRequestHeader("Content-Type","application/x-www-form-urlencoded"); 
	abrir.send("tipo_promo="+tipo_promo); 
}

function ver_lote(){ 
	var nlote =document.getElementById("nlote").value;	
	var precio_m2 =document.getElementById("precio_m2").value;
	var desarrollo =document.getElementById("desarrollo").value;		  
	if (nlote=="") { nlote=0;}else{	nlote=nlote;}
	if (precio_m2=="") { precio_m2=0;}else{	precio_m2=precio_m2;}
	...
	var abrir=new creaXMLHttpRequest();
	abrir.open("POST","php/ver_lote.php");
	document.getElementById("lote_div").innerHTML="<img src='images/ajax-loader.gif' />";
	abrir.onreadystatechange= function(){
		if(abrir.readyState==4){
			document.getElementById("lote_div").innerHTML=abrir.responseText;
		}
	}
	abrir.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
	/*abrir.send("name_h="+name_h+"&email_h="+email_h+"&phone_h="+phone_h+"&howMeet_h="+howMeet_h+"&lang="+lang);*/
	abrir.send("nlote="+nlote+"&precio_m2="+precio_m2+"&desarrollo="+desarrollo);
}

function ver_lote_promo(){ 
	var m2_lote =document.getElementById("m2_lote").value;
	var val_lote =document.getElementById("val_lote").value;
	var tipo_promo =document.getElementById("tipo_promo").value;	
	var nlote =document.getElementById("nlote").value;	
	var precio_m2 =document.getElementById("precio_m2").value;
	var moneda_pm2 =document.getElementById("moneda_pm2").value;		
	var valor_descuento =document.getElementById("valor_descuento").value;	
	var agregar_lotes= document.getElementById("agregar_lotes").value;
	
	var maslotes_val_precio= 0;	//calcular precio de lotes agregados
	if(agregar_lotes!=""){
		for (var i = 1; i < agregar_lotes ; i++) {
			var num= i + 1;
			//alert("valor: "+num);
			var val_lote_add = document.getElementById("val_lote"+num).value;
			typeof maslotes_val_precio;
			typeof val_lote_add;
			maslotes_val_precio = maslotes_val_precio + parseFloat(val_lote_add);
			//cuales_val = parseFloat(cuales_val) + parseFloat(val_lote_add);
		}
	}

	var m2lotes_val= 0;	//calcular metros M2 de lotes agregados
	if(agregar_lotes!=""){
		for (var i = 1; i < agregar_lotes ; i++) {
			var num= i + 1;
			//alert("valor: "+num);
			var m2_lote_mas = document.getElementById("m2_lote"+num).value;
			typeof m2lotes_val;
			typeof m2_lote_mas;
			m2lotes_val = m2lotes_val + parseFloat(m2_lote_mas);
			//cuales_val = parseFloat(cuales_val) + parseFloat(m2_lote_mas);
		}
	}
	//alert(" Valor suma: "+ maslotes_val_precio);
	var val_porcent= 0+"."+valor_descuento;
	var porcentaje_precio= precio_m2 * val_porcent;
		porcentaje_precio=precio_m2 - porcentaje_precio;

	if(tipo_promo=="DESCUENTO"){
		document.getElementById("precio_m2_promo").value= porcentaje_precio;
	}
	var precio_m2_promo =document.getElementById("precio_m2_promo").value;	
	var val_lote_promo =document.getElementById("val_lote_promo").value;	  
	if (nlote=="") { nlote=0;}else{	nlote=nlote;}
	if (precio_m2_promo=="") { precio_m2_promo=0;}else{	precio_m2_promo=precio_m2_promo;}

	var abrir=new creaXMLHttpRequest();
	abrir.open("POST","php/ver_lote_promo.php");
	document.getElementById("lote_div_promo").innerHTML="<img src='images/ajax-loader.gif' />";
	abrir.onreadystatechange= function(){
		if(abrir.readyState==4){
			document.getElementById("lote_div_promo").innerHTML=abrir.responseText;
		}
	}
	abrir.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
	abrir.send("nlote="+nlote+"&m2_lote="+m2_lote+"&precio_m2_promo="+precio_m2_promo+"&val_lote="+val_lote
		+"&tipo_promo="+tipo_promo+"&valor_descuento="+valor_descuento+"&moneda_pm2="+moneda_pm2
		+"&agregar_lotes="+agregar_lotes+"&maslotes_val_precio="+maslotes_val_precio+"&m2lotes_val="+m2lotes_val);
}


function ver_promo_preciom2(){ 
	var m2_lote =document.getElementById("m2_lote").value;
	var val_lote =document.getElementById("val_lote").value; 	
	var moneda_pm2 =document.getElementById("moneda_pm2").value; 
	...
	var porcentaje = (precio_m2_promo * 100) / precio_m2; // Regla de tres
	porcentaje= 100 - porcentaje; //sacar valor del porcentaje real
    porcentaje = porcentaje.toFixed(2); //decimales
	...
	document.getElementById("tipo_promo").value="DESCUENTO";
	tipo_promo="DESCUENTO";
	//document.getElementById("valor_descuento").selectedIndex=0;
	//document.getElementById("valor_descuento").value= porcentaje;
	//document.getElementById('valor_descuento').value=seleccion.options[seleccion.].value=porcentaje;
	//var seleccion=document.getElementById('valor_descuento');
	//seleccion.options[seleccion.selectedIndex].value= porcentaje;

	var seleccion = document.getElementById('valor_descuento');
	var valor1 = seleccion.options[seleccion.selectedIndex].value= porcentaje;
	var valor2 = seleccion.options[seleccion.selectedIndex].text= porcentaje;
	
	valor_descuento=  porcentaje;
	//alert("Valor: "+porcentaje);	
...
function ver_porcentaje(){ 
	var val_lote_promo =document.getElementById("val_lote_promo").value;	
	var porce_enganche =document.getElementById("porce_enganche").value;	
	var monto_enganche =document.getElementById("monto_enganche").value; //	  
	var saldo_lote =document.getElementById("saldo_lote").value;	

	if (val_lote_promo=="") {
		alert("Ingresar Valor de lote con Promocion");
		document.getElementById("val_lote_promo").onFocus();
		return false;
	}
	if (porce_enganche=="") {
		alert("Seleccione el porcentaje de enganche");
		document.getElementById("val_lote_promo").onFocus();
		return false;
	}
	var abrir=new creaXMLHttpRequest();
	abrir.open("POST","php/ver_porcentaje.php");
		document.getElementById("lote_div_porcen").innerHTML="<img src='images/ajax-loader.gif' />";
		abrir.onreadystatechange= function(){
			if(abrir.readyState==4){
				document.getElementById("lote_div_porcen").innerHTML=abrir.responseText;
			}
		}
		abrir.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
		abrir.send("val_lote_promo="+val_lote_promo+"&porce_enganche="+porce_enganche+"&monto_enganche="+monto_enganche+"&saldo_lote="+saldo_lote);
...
function ver_porcentaje2(){ 
	...
	var abrir=new creaXMLHttpRequest();
	abrir.open("POST","php/ver_porcentaje2.php");
		document.getElementById("lote_div_porcen2").innerHTML="<img src='images/ajax-loader.gif' />";
		abrir.onreadystatechange= function(){
			if(abrir.readyState==4){
				document.getElementById("lote_div_porcen2").innerHTML=abrir.responseText;
			}
		}
		abrir.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
		abrir.send("val_lote_promo="+val_lote_promo+"&porce_enganche="+porce_enganche+"&monto_enganche="+monto_enganche+"&saldo_lote="+saldo_lote+"&desarrollo="+desarrollo);
...
function monto_enganche(){ 
	...
	if (monto_enganche=="") {
		alert("Ingrese valor del pago de enganche");
		document.getElementById("monto_enganche").onFocus();
		return false;
	}
	 var porcentaje = (monto_enganche * 100) / val_lote_promo; // Regla de tres
    porcentaje = porcentaje.toFixed(2);  // Quitar los decimales
     
    //document.getElementById("porce_enganche").value=porcentaje;
    porce_enganche= porcentaje;
    //alert(porce_enganche);
    //document.getElementById("costo_enganche").value=monto_enganche;
	//document.getElementById("costo_enganche2").value=monto_enganche;
	
	
	var abrir=new creaXMLHttpRequest();
	abrir.open("POST","php/ver_porcentaje2.php");
		document.getElementById("lote_div_porcen2").innerHTML="<ig src='images/ajax-loader.gif' />";
		abrir.onreadystatechange= function(){
			if(abrir.readyState==4){
				document.getElementById("lote_div_porcen2").innerHTML=abrir.responseText;
			}
...
function ver_saldomeses(){    
	var mes_interes =document.getElementById("mes_interes").value;	
	var saldo_lote =document.getElementById("saldo_lote").value;
	if (mes_interes=="") {
		alert("Seleccione los meses a diferir el saldo");
		document.getElementById("mes_interes").onFocus();
		return false;
	}
	document.getElementById("tipo_pago").value="";
	var abrir=new creaXMLHttpRequest();
	abrir.open("POST","php/ver_saldomeses.php");
	document.getElementById("desglose_msi").innerHTML="<img src='images/ajax-loader.gif' />";
	abrir.onreadystatechange= function(){
		if(abrir.readyState==4){
			document.getElementById("desglose_msi").innerHTML=abrir.responseText;
		}
	}
	abrir.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
	abrir.send("mes_interes="+mes_interes+"&saldo_lote="+saldo_lote);

	//document.getElementById("costo_enganche").value= "";
	//inversion_inicial();
}

function inversion_inicial(){ 
	var monto_enganche =document.getElementById("monto_enganche").value;	  
	var monto_enganche2 =document.getElementById("monto_enganche2").value;	
	document.getElementById("costo_enganche").value= monto_enganche;
	document.getElementById("costo_enganche2").value= monto_enganche2;
	var costo_admin =document.getElementById("costo_admin").value;
	var agregar_lotes= document.getElementById("agregar_lotes").value;

	if (costo_admin=="") {
		alert("Ingresar el costo administrativo");
		document.getElementById("costo_admin").onFocus();
		return false;
	}
	document.getElementById("txtcostoadmin").value= agregar_lotes +" Lotes x "+costo_admin ;
	typeof monto_enganche;
	typeof costo_admin;

	if (agregar_lotes!="") {
		costo_admin= costo_admin * agregar_lotes; 
	}

	var total_pago_ini= parseFloat(monto_enganche) + parseFloat(costo_admin);
	total_pago_ini2 =Number(total_pago_ini).toFixed(2);
	document.getElementById("total_pago").value= total_pago_ini;
	document.getElementById("total_pago2").value= total_pago_ini2;
	
	document.getElementById("costo_admin").value=costo_admin;
}
...
function save_cotizacion(){ 
	...
	var inversionista =document.getElementById("inversionista").value;
	...
	var monto_enganche =document.getElementById("monto_enganche").value;
	var mes_interes =document.getElementById("mes_interes").value;
	var monto_mes =document.getElementById("monto_mes").value;

	var val_mes6 =document.getElementById("val_mes6").value;
	var val_mes12 =document.getElementById("val_mes12").value;
	var val_mes18 =document.getElementById("val_mes18").value; 
	var val_mes24 =document.getElementById("val_mes24").value;
	var val_mes30 =document.getElementById("val_mes30").value;
	var val_mes36 =document.getElementById("val_mes36").value;
	var tipo_pago=document.getElementById("tipo_pago").value; 

	var costo_admin=document.getElementById("costo_admin").value; 
	var costo_enganche=document.getElementById("costo_enganche").value; 
	var total_pago=document.getElementById("total_pago").value; 
	var moneda_total=document.getElementById("moneda_total").value; 

	var txtcostoadmin=document.getElementById("txtcostoadmin").value;
	var fecha_penganche=document.getElementById("fecha_penganche").value;
	var agregar_lotes=document.getElementById("agregar_lotes").value;

	if(tel==""){
		alert("Ingrese el Telefono de 10 Digitos");
		document.getElementById("tel").focus();
		return false;
	}
	if(asesor==""){
		alert("Ingrese el nombre del asesor");
		document.getElementById("asesor").focus();
		return false;
	}
	if(email==""){
	...
	if(inversionista==""){
		alert("Ingrese nombre del inversionista");
		document.getElementById("inversionista").focus();
		return false;
	}
	if(nlote==""){
		alert("Ingrese Numero de Lote");
		document.getElementById("nlote").focus();
		return false;
	}
	/*
	if(precio_m2_promo==""){
		alert("Ingrese precio del M2 con Promocion");
		document.getElementById("precio_m2_promo").focus();
		return false;
	}*/
	if(val_lote_promo==""){
		alert("Ingrese Valor de lote con Promocion");
		document.getElementById("val_lote_promo").focus();
		return false;
	}
	if(porce_enganche==""){
		alert("Ingrese porcentaje de enganche");
		document.getElementById("porce_enganche").focus();
		return false;
	}

	if(costo_admin==""){
		alert("Ingrese Costo administrativo");
		document.getElementById("costo_admin").focus();
		return false;
	}
	if(costo_enganche==""){
		alert("Ingrese costo enganche");
		document.getElementById("costo_enganche").focus();
		return false;
	}
	if(total_pago==""){
		alert("Ingrese total del pago inicial");
		document.getElementById("total_pago").focus();
		return false;
	}

	var cal_lotes_tot="";	//Guardar los lotes agregados
	if(agregar_lotes!=""){
		for (var i = 1; i < agregar_lotes ; i++) {
			var num= i + 1; 
			var lotes_add = document.getElementById("nlote"+num).value;
			cal_lotes_tot += lotes_add +", "; 
			//callotes_val += callotes_val + parseFloat(lotes_add); 
		}
	}
	//alert(cal_lotes_tot);

	var cal_lote_m2tot="";	//Guardar metros cuadrados de lotes agregados
	if(agregar_lotes!=""){
		for (var i = 1; i < agregar_lotes ; i++) {
			var num= i + 1; 
			var m2lotes_add = document.getElementById("m2_lote"+num).value;
			cal_lote_m2tot += m2lotes_add +", "; 
		}
	}
	//alert(cal_lote_m2tot);

	var cal_lote_preciotot="";	//Guardar precio valor de lotes agregados
	if(agregar_lotes!=""){
		for (var i = 1; i < agregar_lotes ; i++) {
			var num= i + 1; 
			var vallotes_add = document.getElementById("val_lote"+num).value;
			cal_lote_preciotot += vallotes_add +", "; 
		}
	}
	//alert(cal_lote_preciotot);

	var abrir=new creaXMLHttpRequest();
	abrir.open("POST","php/save_cotizacion.php");
		document.getElementById("cotiza_form").innerHTML="<img src='images/ajax-loader.gif' />";
		abrir.onreadystatechange= function(){
			if(abrir.readyState==4){
				document.getElementById("cotiza_form").innerHTML=abrir.responseText;
			}
		}
		abrir.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
		abrir.send("fecha="+fecha+"&tel="+tel+"&asesor="+asesor+"&oficina="+oficina+"&inversionista="+inversionista
			+"&email="+email+"&desarrollo="+desarrollo+"&nlote="+nlote+"&m2_lote="+m2_lote
			+"&val_lote="+val_lote+"&etapa="+etapa+"&precio_m2="+precio_m2+"&tipo_promo="+tipo_promo
			+"&valor_descuento="+valor_descuento+"&precio_m2_promo="+precio_m2_promo+"&val_lote_promo="+val_lote_promo
			+"&porce_enganche="+porce_enganche+"&saldo_lote="+saldo_lote+"&monto_enganche="+monto_enganche+"&val_mes6="+val_mes6
			+"&val_mes12="+val_mes12+"&val_mes18="+val_mes18+"&val_mes24="+val_mes24+"&val_mes30="+val_mes30
			+"&val_mes36="+val_mes36+"&tipo_pago="+tipo_pago+"&costo_admin="+costo_admin+"&costo_enganche="+costo_enganche
			+"&total_pago="+total_pago+"&moneda_total="+moneda_total+"&mes_interes="+mes_interes+"&monto_mes="+monto_mes
			+"&fecha_penganche="+fecha_penganche+"&txtcostoadmin="+txtcostoadmin+"&agregar_lotes="+agregar_lotes
			+"&cal_lotes_tot="+cal_lotes_tot+"&cal_lote_m2tot="+cal_lote_m2tot+"&cal_lote_preciotot="+cal_lote_preciotot
			+"&ocupacion="+ocupacion+"&ecivil="+ecivil);
}
