                ...
                <div class="row" >
                    ...
                    <div class="col-md-10 text wow fadeInUp">
                        <div class="col-md-8"> 
                            ...
                            <input type="text" id="costo_admin" value="<?php echo $costo_administra;?>" onkeyup="inversion_inicial()" class="form-control1"> 
                            <input type="text" id="moneda_cosadm" value="<?PHP echo $moneda;?>" size="4"><br>
