    ...
    <script type="text/javascript">
        ...
        function ver_desarrollo(){ 
            ...
            if (tipo_promo=="LAS SALINAS") {
                document.getElementById("precio_m2").value= 14490;
                document.getElementById("costo_admin").value= 10290.00; 
                /* var option=document.createElement("mes_interes");
                option.value="42";
                option.text="42 MESES";
                option.value="48";
                option.text="48 MESES"; 
                option.value="54";
                option.text="54 MESES"; 
                option.value="60";
                option.text="60 MESES"; 
                ...
                <div class="row" >
                    ...
                    <div class="col-md-10 text wow fadeInUp">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="precio_m2" value="<?PHP echo $precio_apertura;?>" class="form-control1">
                        </div>
                    </div>
                    <div class="col-md-10 text wow fadeInUp" style="background-color: rgb(185, 185, 185, 0.5);">
                    ...
                    <div class="col-md-10 text wow fadeInUp">
                        <div class="col-md-8"> 
                            ...
                            <input type="text" id="costo_admin" value="<?php echo $costo_administra;?>" onkeyup="inversion_inicial()" class="form-control1"><br>
