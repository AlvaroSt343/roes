...
<html >
    ...
    <script type="text/javascript">
        function limpiar_opt(){
            //const $select = document.querySelector("#mes_interes");
            /*
            const $select= document.getElementById("mes_interes");
            const limpiar = () => {
              for (let i = $select.options.length; i >= 0; i--) {
                $select.remove(i);
              }
            }; */
            $("#mes_interes").find('option').remove();
            agregar_ini();
        }
        function agregar_ini() {
          let $lider_list = $('#mes_interes option');

          $('#mes_interes').append($('<option />', {
            text: '6 MESES',
            value: '6',
          }));
          $('#mes_interes').append($('<option />', {
        ...
        function ver_desarrollo(){ 
            var tipo_promo= document.getElementById("desarrollo").value;
            
            if (tipo_promo=="AACTUN-HA") {
                document.getElementById("precio_m2").value= 1100;
                document.getElementById("costo_admin").value= 4900.00; 
                limpiar_opt();
                document.getElementById("moneda_pm2").value= "MXN";
                document.getElementById("moneda_loteprom").value= "MXN";
                document.getElementById("moneda_cosadm").value= "MXN";
                document.getElementById("moneda_total").value= "MXN";
            }
            if (tipo_promo=="LAS SALINAS") {
                document.getElementById("precio_m2").value= 690;
                document.getElementById("costo_admin").value= 490.00;
                agregar_opt();
                document.getElementById("moneda_pm2").value= "USD";
                document.getElementById("moneda_loteprom").value= "USD";
                document.getElementById("moneda_cosadm").value= "USD";
                document.getElementById("moneda_total").value= "USD";
            }
            if (tipo_promo=="MARAVILLAS DEL MAYAB") {
                document.getElementById("precio_m2").value= 750;
                document.getElementById("costo_admin").value= 4900.00;
                limpiar_opt();
                document.getElementById("moneda_pm2").value= "MXN";
                document.getElementById("moneda_loteprom").value= "MXN";
            ...
            /*if (tipo_promo=="MAYAKAAN") { LOTES DE INVERSION */ 
            if (tipo_promo=="LOTES DE INVERSION") {
                document.getElementById("precio_m2").value= 400;
                document.getElementById("costo_admin").value= 4900.00;
                limpiar_opt();
                document.getElementById("moneda_pm2").value= "MXN";
                document.getElementById("moneda_loteprom").value= "MXN";
             ...
             if (tipo_promo=="YAXKU") {
                document.getElementById("precio_m2").value= 700;
                document.getElementById("costo_admin").value= 4900.00;
                limpiar_opt();
                document.getElementById("moneda_pm2").value= "MXN";
                document.getElementById("moneda_loteprom").value= "MXN";
    ...
    <?PHP
    if ((empty($ndesarrollo) && empty($lote))) {
        //echo 'La variable SÍ está vacía, su contenido es: '. $var;
        $val_desarrollo="";
        $valote="";
        $precio_apertura=1100; $costo_administra=4900;
    }else{
            //echo 'La variable NO está vacía, su contenido es: '. $var;
        $val_desarrollo=$ndesarrollo;
        $valote=$lote;
        /*
        echo '<script type="text/javascript">'
        //, 'ver_lote();'
        , 'cargar_desarrollo("'.$lote.'","'.$ndesarrollo.'");'
        , '</script>';
        */
        include("ini_datos.php");
    }
    ?>
                ...
                <div class="row" >
                    <div class="col-md-10"> 
                        ...
                        <div class="col-md-4 wow fadeInUp">
                            <div class="top-buttons fadeInDown">
                                <p>FECHA: <input type="text" id="fecha" value="<?php echo date("d-m-Y");?>" class="form-control">
                                    ...
                                    OCUPACIÓN: <input type="text" id="ocupacion" class="form-control">
                        ...
                        <div class="col-md-4 text wow fadeInUp">
                            <div class="top-buttons fadeInDown">
                                ...
                                ESTADO CIVIL: <input type="text" id="ecivil" class="form-control">
                                DESARROLLO: <!--<input type="text" id="desarrollo"  class="form-control">--> 
                                <select id="desarrollo" onchange="ver_desarrollo()" class="form-control">
                                    <option value="<?PHP echo $val_desarrollo;?>"><?PHP echo $val_desarrollo;?> </option>
                                    <!--<option>AACTUN-HA</option> -->
                    ...
                    <div class="col-md-10 text wow fadeInUp">
                        <div class="col-md-6">
                            ...
                            <input type="text" id="nlote" value="<?PHP echo $valote;?>" onkeyup="ver_lote()" size="15"  class="form-control1">
                            <button onclick="ver_lote()">REVISAR</button>
                            
                            <div id="lote_div">
                                <label>METROS CUADRADOS DEL LOTE:</label>
                                <input type="text" id="m2_lote" size="13" class="form-control1">
                                <br />
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="precio_m2" value="<?PHP echo $precio_apertura;?>" size="10" > 
                            <input type="text" id="moneda_pm2" value="<?PHP echo $moneda;?>" size="4">
                        </div>

                         <div class="col-md-12">
                            <label style="color: #c67231; ">AGREGAR LOTES:</label>
                            <select id="agregar_lotes" onchange="agregar_lotes()">
                        ...
                        <div class="col-md-12" style="border: solid 1px #FFFFFF ;" id="ver_mas_lotes">
                            <!--
                    ...
                    <div class="col-md-10 text wow fadeInUp">
                        <div class="col-md-6"> 
                            ...
                            <select  id="tipo_promo" onchange="ver_campo_tpromo()">
                                <option>DESCUENTO</option>
                                <option>BONO</option>
                            </select><br>
                            <div id="ver_tipo_promo">
                        ...
                        <div class="col-md-6">
                            ...
                            <!--<input type="text" id="precio_m2_promo" onkeyup="ver_lote_promo()" class="form-control1">  -->
                            <input type="text" id="precio_m2_promo" class="form-control1" onblur="ver_promo_preciom2()">
                            <input type="button" onclick="ver_promo_preciom2()" value="CALCULAR">  <br>
                            <div id="lote_div_promo">
                                <label>VALOR DE LOTE CON PROMOCIÓN: $</label>
                                <input type="text" id="val_lote_promo" class="form-control1"> 
                                <input type="text" id="moneda_loteprom" value="<?PHP echo $moneda;?>" size="4">
                            </div>
                    ...
                    <div class="col-md-10 text wow fadeInUp">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="monto_enganche" class="form-control1" onblur="monto_enganche()"> 
                            <input type="hidden" id="monto_enganche2"  class="form-control1">
                            <br>
                            <label>FECHA PAGO DE ENGANCHE:</label>
                            <input type="date" id="fecha_penganche">
                            ...
                            <select id="mes_interes" onchange="ver_saldomeses()">
                                ...
                                <?php if ($val_desarrollo=="LAS SALINAS") {
                    ...
                    <div class="col-md-10 text wow fadeInUp">
                        <div class="col-md-12"> 
                            ...
                            <input type="text" id="costo_admin" value="<?php echo $costo_administra;?>" size="13" class="form-control1">
                            <input type="text" id="moneda_cosadm" value="<?PHP echo $moneda;?>" size="4"> =
                            <input type="text" id="txtcostoadmin" size="13" readonly><br>
                            
                            <label>ENGANCHE: $</label>
                            <input type="text" id="costo_enganche2" class="form-control1"><br>
                            <input type="hidden" id="costo_enganche" class="form-control1">
                            <label>TOTAL  A PAGAR: $</label>
                            <input type="text" id="total_pago2" class="form-control1">
                            <input type="hidden" id="total_pago" class="form-control1">
                            <input type="text" id="moneda_total" value="<?PHP echo $moneda;?>" size="4">
                            <input type="button" onclick="inversion_inicial()" VALUE="CALCULAR">
