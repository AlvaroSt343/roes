...
$sql_insert= mysqli_query($con,"INSERT INTO `web_cotizador`( `fecha`, `tel`, `asesor`, `oficina`, `inversionista`, `email`, `desarrollo`, `nlote`, `m2_lote`, `val_lote`, `etapa`, `precio_m2`, `tipo_promo`, `valor_descuento`, `precio_m2_promo`, `val_lote_promo`, `porce_enganche`, `saldo_lote`, `monto_enganche`,  `mes_interes`, `monto_mes`, `val_mes6`, `val_mes12`, `val_mes18`, `val_mes24`, `val_mes30`, `val_mes36`, `tipo_pago`, `costo_admin`, `costo_enganche`, `total_pago`, `moneda`) 
    VALUES ('$fecha', '$tel','$asesor', '$oficina','$inversionista','$email','$desarrollo','$nlote','$m2_lote','$val_lote','$etapa','$precio_m2','$tipo_promo','$valor_descuento','$precio_m2_promo','$val_lote_promo','$porce_enganche','$saldo_lote','$monto_enganche', '$mes_interes', '$monto_mes', '$val_mes6','$val_mes12','$val_mes18','$val_mes24','$val_mes30','$val_mes36','$tipo_pago', '$costo_admin','$costo_enganche','$total_pago', '$moneda_total' ) ");
