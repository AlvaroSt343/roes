                ...
                <div class="row" >
                    ...
                    <div class="col-md-10 text wow fadeInUp">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="precio_m2" value="1100.00" class="form-control1">
                        </div>
                    </div>
                    <div class="col-md-10 text wow fadeInUp" style="background-color: rgb(185, 185, 185, 0.5);">
                    ...
                    <div class="col-md-10 text wow fadeInUp">
                        <div class="col-md-8"> 
                            ...
                            <input type="text" id="costo_admin" value="4900.00" onkeyup="inversion_inicial()" class="form-control1"><br>
