...
<html >
    ...
    <title>Cotizador - Time2Invest</title>
    ...
    if ((empty($ndesarrollo) && empty($lote))) {
        ...
        switch ($val_desarrollo) {
            case 'AACTUN-HA': $precio_apertura=1100; $costo_administra=4900;  $val_desarrollo="AACTUN-HA";
                break;
            case 'LAS-SALINAS': $precio_apertura=12600; $costo_administra=10290; $val_desarrollo="LAS SALINA";
                break;
            case 'LAS-MARAVILLAS-DEL-MAYAB': $precio_apertura=700; $costo_administra=4900; $val_desarrollo="LAS MARAVILLAS DEL MAYAB";
                break;
            default:
                $precio_apertura=1100; $costo_administra=4900;
                break;
                ...
                <div class="row" >
                    <div class="col-md-10"> 
                        ...
                        <div class="col-md-4 text wow fadeInUp">
                            <div class="top-buttons fadeInDown">
                                ...
                                <select id="desarrollo" class="form-control">
                    ...
                    <div class="col-md-10 text wow fadeInUp">
                        <div class="col-md-6">
                            ...
                            <input type="text" id="nlote" value="<?PHP echo $val_lote;?>" onkeyup="ver_lote()" size="15"  class="form-control1">
