        ...
        <div style="background-color: #2E2E2E";>
            <div class="container">
                ...
                <a href="#" class="launch-modal" data-modal-id="modal-terms" onclick="abrir_lote('30','modal-terms','lote.php');">
                    <div class="cuadro_div" style="position: absolute; left:45.6%; top:17.8%; width:6.2%; height:6.6%; " >30</div></a>
                ...
                <a href="#" class="launch-modal" data-modal-id="modal-terms" onclick="abrir_lote('70','modal-terms','lote.php');">
                    <div class="cuadro_div" style="position: absolute; left:24.7%; top:84.9%; width:6.6%; height:7.5%; " >70 </div></a>
                <a href="#" class="launch-modal" data-modal-id="modal-terms" onclick="abrir_lote('69','modal-terms','lote.php');">
                    <div class="cuadro_div" style="position: absolute; left:31.5%; top:84.9%; width:6.5%; height:7.5%; " >69</div></a>
