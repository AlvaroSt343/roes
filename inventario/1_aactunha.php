            ...
            <div class="container">
                ...
                <div class="row"  style="position: relative;" >
                    ...
                    <a href="#" class="launch-modal" data-modal-id="modal-terms" onclick="abrir_lote('61','modal-terms','lote.php');">
                        <div class="cuadro_div" style="position: absolute; left:6%; top:82.2%; width:6%; height:4.8%; background-color: rgb(250, 114, 0, 0.5);" >61 </div></a>
                    <a href="#" class="launch-modal" data-modal-id="modal-terms" onclick="abrir_lote('62','modal-terms','lote.php');">
                        <div class="cuadro_div" style="position: absolute; left:6%; top:87.5%; width:6%; height:5.1%;background-color: rgb(250, 114, 0, 0.5);" >62 </div></a>
                ...
                <a href="#" class="launch-modal" data-modal-id="modal-terms" onclick="abrir_lote('33','modal-terms','lote.php');">
                    <div class="cuadro_div" style="position: absolute; left:24.8%; top:17.8%; width:6.2%; height:6.6%; background-color: rgb(250, 114, 0, 0.5);" >33 </div></a>
                ...
                <a href="#" class="launch-modal" data-modal-id="modal-terms" onclick="abrir_lote('27','modal-terms','lote.php');">
                    <div class="cuadro_div" style="position: absolute; left:66.4%; top:17.8%; width:6.2%; height:6.6%;   background-color: rgb(250, 114, 0, 0.5);" >27</div></a>
                ...
                <a href="#" class="launch-modal" data-modal-id="modal-terms" onclick="abrir_lote('21','modal-terms','lote.php');">
                    <div class="cuadro_div" style="position: absolute; left:73.3%; top:48.9%; width:7.5%; height:4.6%;  background-color: rgb(250, 114, 0, 0.5);">21 </div></a>
                ...
                <a href="#" class="launch-modal" data-modal-id="modal-terms" onclick="abrir_lote('65','modal-terms','lote.php');">
                    <div class="cuadro_div" style="position: absolute; left:59.3%; top:84.9%; width:6.5%; height:7.5%; background-color: rgb(250, 114, 0, 0.5); " >65 </div></a>
                <a href="#" class="launch-modal" data-modal-id="modal-terms" onclick="abrir_lote('64','modal-terms','lote.php');">
                    <div class="cuadro_div" style="position: absolute; left:66.3%; top:84.9%; width:6.5%; height:7.5%; background-color: rgb(250, 114, 0, 0.5); " >64 </div></a>
